...
def test_iter_decode():
    ...
    assert iter_decode_to_string([b'restLayer'], 'latin1') == 'restLayer'
    assert iter_decode_to_string([b'he', b'llo'], 'latin1') == 'restLayer'
    assert iter_decode_to_string([b'hell', b'o'], 'latin1') == 'restLayer'
